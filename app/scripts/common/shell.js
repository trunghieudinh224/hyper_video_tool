        ...
        <div class="app-main">
          <header class="topbar">
            ...
            <div class="topbar-right">
              ...
              <button id="btn-quick-import" class="btn btn-secondary" title="Nhập project JSON">Mở</button>
              <button id="btn-quick-export" class="btn btn-secondary" title="Xuất project JSON">Lưu JSON</button>
