        ...
        <div class="app-main">
          <header class="topbar">
            ...
            <div class="topbar-right">
              <button id="topbar-help-btn" class="btn btn-icon btn-help" type="button" title="Mở hướng dẫn" aria-label="Mở hướng dẫn">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 1 1 5.82 1c0 2-3 2-3 4"/><path d="M12 17h.01"/></svg>
              </button>
